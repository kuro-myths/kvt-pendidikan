        ...
        <aside class="w-64 bg-zinc-950 border-r border-white/5 flex flex-col fixed h-full z-30 transition-transform duration-300"
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <div class="pt-4">
                    ...
                    <a href="{{ route('admin.edu-tools.index') }}" class="sidebar-link {{ request()->routeIs('admin.edu-tools.*') ? 'active' : '' }}">
                ...
                <div class="pt-4">
                    ...
                    <a href="{{ route('sekolah.edu-tools.index') }}" class="sidebar-link {{ request()->routeIs('sekolah.edu-tools.*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                        Edu Tools
                    </a>
                </div>
                ...
                <div class="pt-4">
                    ...
                    <a href="{{ route('guru.edu-tools.index') }}" class="sidebar-link {{ request()->routeIs('guru.edu-tools.*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                        Edu Tools
                    </a>
                </div>
                ...
                <div class="pt-4">
                    ...
                    <a href="{{ route('siswa.edu-tools.index') }}" class="sidebar-link {{ request()->routeIs('siswa.edu-tools.*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                        Edu Tools
                    </a>
                </div>
