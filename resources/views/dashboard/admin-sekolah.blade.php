...
<div class="grid md:grid-cols-2 gap-6">
    ...
    <div class="bg-zinc-950 border border-white/5 rounded-2xl p-6">
        ...
        <div class="grid grid-cols-2 gap-3">
            <a href="{{ route('users.create') }}" class="bg-white/5 hover:bg-white/10 rounded-xl p-4 text-center transition-colors">
            ...
            <a href="{{ route('classes.create') }}" class="bg-white/5 hover:bg-white/10 rounded-xl p-4 text-center transition-colors">
            ...
            <a href="{{ route('users.index') }}?role=guru" class="bg-white/5 hover:bg-white/10 rounded-xl p-4 text-center transition-colors">
            ...
            <a href="{{ route('users.index') }}?role=siswa" class="bg-white/5 hover:bg-white/10 rounded-xl p-4 text-center transition-colors">
